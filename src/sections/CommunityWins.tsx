      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <ScrollReveal delay={0.1}>
          <h2 className="text-white text-4xl font-bold mb-2">
            Real <span className="text-[#d4a843]">Wins</span> from our members
          </h2>
        </ScrollReveal>

        <ScrollReveal delay={0.2}>
          <p className="text-[#a0a0a0] text-base mb-12">
            Trading wins shared by members using our AI signals
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal className="flex flex-col items-center mt-12 gap-4">
          ...
          <p className="text-[#a0a0a0] text-sm text-center">
            Ready to trade with the same AI signals behind these member wins?
          </p>
        </ScrollReveal>
      </div>
    </section>
