...
import {
  ...
  Phone as PhoneIcon, KeyRound, CheckCircle2, Eye, EyeOff,
} from "lucide-react";
      ...
      <div className="min-h-screen bg-[#050505] text-white flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="bg-[#0d0d0d] border border-[#1f1f1f] rounded-2xl p-6">
            {/* Critical message: until the code is verified, the account does NOT exist
                in the users table. If they try to log in now, it will say "wrong
                password". Many users miss this — make it impossible to miss. */}
              ...
              <div className="flex gap-2.5">
                ...
                <div className="text-[12px] leading-relaxed">
                  ...
                  <p className="text-[#a0a0a0]">
                    You must enter the 6-digit code below to finish creating your account.
                    If you try to log in before verifying, your password won't work.
                  </p>
                  <p className="text-[#a0a0a0] mt-1.5">
                    <span className="text-[#d4a843] font-semibold">Don't see the email?</span>{" "}
                    Check your <span className="text-white font-semibold">Spam / Junk folder</span>{" "}
                    — verification emails often land there. You can also use the
                    "Resend code" button below.
                  </p>
                </div>
              </div>
            </div>
              ...
              {mode === "login" && (
                <div className="mt-2 text-right">
                  <button
                    ...
                    className="text-xs text-[#d4a843] hover:text-[#e8c76a] transition-colors"
                  >
                    Forgot password?
                  </button>
                </div>
